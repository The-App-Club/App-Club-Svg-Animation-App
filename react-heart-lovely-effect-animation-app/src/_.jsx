...
const App = ({
  ...
  //     return circleDomRef.current;
  //   });
  //   console.log(circleDomList);
  //   tl.to(circleDomList, {
  //     duration: 0.3,
  //     ease: 'power4',
  //     opacity: 0,
  //     r: (i) => {
  //       return circleInfoList[i].r;
  //     },
  //     cx: (i) => {
  //       return (
  //         circleInfoList[i].cx + chance().integer({min: -10, max: -5}) / 10
  //       );
  //     },
  //     cy: (i) => {
  //       return (
  //         circleInfoList[i].cy + chance().integer({min: -10, max: -5}) / 10
  //       );
  //     },
  //   })
  //     .to(circleDomList, {
  //       r: (i) => {
  //         return circleInfoList[i].r + Math.random() * 1.2 + 0.2;
  //       },
  //       cx: (i) => {
  //         return circleInfoList[i].cx + chance().integer({min: -10, max: 10});
  //       },
  //       cy: (i) => {
  //         return circleInfoList[i].cy + chance().integer({min: -10, max: 10});
  //       },
  //       opacity: 1,
  //       duration: 0.9,
  //       ease: 'sine.in',
  ...
  //       },
  //       cx: (i) => {
  //         return circleInfoList[i].cx;
  //       },
  //       cy: (i) => {
  //         return circleInfoList[i].cy;
  //       },
  //     });
  // }, []);
