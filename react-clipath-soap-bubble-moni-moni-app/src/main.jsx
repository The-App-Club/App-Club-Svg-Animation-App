    ...
    <>
      ...
      >
        ...
        >
          ...
          <g transform="translate(-5 0) scale(0.3)">
            <image
              clipPath={`url(#morph)`}
              href={`https://media.giphy.com/media/AWqRqyyLYhZxS/giphy.gif`}
            ></image>
          </g>
          <g transform="translate(-5 80) scale(0.3)">
            <image
              clipPath={`url(#morph)`}
              href={`https://media.giphy.com/media/MeFiwDSGDApHy/giphy.gif`}
            ></image>
          </g>
          <g transform="translate(100 80) scale(0.3)">
            <image
              clipPath={`url(#morph)`}
              href={`https://media.giphy.com/media/vRKJTZ1w731kc/giphy.gif`}
            ></image>
          </g>
        </svg>
      </div>
